...
class HomeController extends Controller
{
    public function index()
    {
        ...
        $last_post = posts::where('verified_at', '!=', null)
            ->select("id", "titre", "photos", "old_achat", "prix", "id_sous_categorie", "statut")
        ...
        $luxurys = posts::join('sous_categories', 'posts.id_sous_categorie', '=', 'sous_categories.id')
            ...
            ->select("posts.id", 'posts.old_achat', "posts.titre", "posts.photos", "posts.prix", "posts.statut", "posts.id_sous_categorie", "categories.id As id_categorie")
            ->get();
