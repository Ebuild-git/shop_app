...
class AdminController extends Controller
{
    ...
    private function buildShipmentPayloadItem($order, $vendorItems)
    {
        ...
        $buyerBuilding  = $buyer->nom_batiment ?? '';
        $buyerFloor     = $buyer->etage ?? '';
        $buyerApartment = $buyer->num_appartement ?? '';
        ...
        $vendorFloor     = $vendor->etage ?? '';
        $vendorApartment = $vendor->num_appartement ?? '';
