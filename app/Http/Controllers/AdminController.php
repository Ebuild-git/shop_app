...
class AdminController extends Controller
{
    ...
    //         try {
    //             $vendorItemCount = $order->items
    //             ->where('vendor_id', $item->vendor_id)
    //             ->count();

    //             $payload  = $this->buildShipmentPayloadItem($order, $item, $vendorItemCount);
    //             $response = $aramex->createPickup($payload);           // ← new method
    ...
    //                 'error'    => $e->getMessage(),
    //             ]);
    //             $results[] = ['item_id' => $item->id, 'success' => false, 'message' => $e->getMessage()];
    //         }
    //     }
    ...
    private function buildShipmentPayloadItem($order, $vendorItems)
    {
            ...
            return [
                ...
                'ThirdParty' => [
                    ...
                    'PartyAddress'  => [
                        ...
                        'BuildingNumber' => null, 'BuildingName' => null,
                        'Floor' => null, 'Apartment' => null, 'POBox' => null, 'Description' => null,
                    ],
                    'Contact' => [
        ...
        return [
            ...
            'Pickup' => [
                ...
                'PickupLocation'  => 'Reception',
                'PickupDate'      => $nowAramex,
                'ReadyTime'       => $nowAramex,
                'LastPickupTime'  => $dueAramex,
                'ClosingTime'     => $dueAramex,
                'Comments'        => '',
    ...
    // private function buildShipmentPayloadItem($order, $item, int $vendorItemCount = 1)
    // {
    //     $buyer  = $order->buyer;
    //     $vendor = $item->vendor;
    //     $post   = $item->post;
    ...
    //             ],
    //         ],
    //         'ThirdParty' => [                          // ← required by new API
    //             'Reference1'    => '',
    //             'Reference2'    => '',
    //             'AccountNumber' => '',
    //             'PartyAddress'  => [
    ...
    //             'GoodsOriginCountry'             => 'MA',
    //             'NumberOfPieces'                 => $vendorItemCount,
    //             'ProductGroup'                   => 'DOM',
    //             'ProductType'                    => 'CDS',
    //             'PaymentType'                    => 'P',
    //             'PaymentOptions'                 => '',
    ...
    //                     'ProductGroup'        => 'DOM',
    //                     'ProductType'         => 'CDS',
    //                     'NumberOfShipments'   => $vendorItemCount,
    //                     'PackageType'         => 'Box',
    //                     'Payment'             => 'P',
    //                     'ShipmentWeight'      => ['Unit' => 'KG', 'Value' => 1],
    //                     'ShipmentVolume'      => null,
    //                     'NumberOfPieces'      => $vendorItemCount,
    //                     'CashAmount'          => null,
    //                     'ExtraCharges'        => null,
