                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <input type="number" class="form-control cusor border-r" placeholder="{{ __('placeholder_price') }}" required
                            wire:model.blur="prix" onwheel="this.blur()" step="any">
                        @error('prix')
                            <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <input type="number" class="form-control cusor border-r " placeholder="{{ __('placeholder_initial_price') }}"
                            wire:model.blur="prix_achat" onwheel="this.blur()" step="any">
                        @error('prix_achat')
                            <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div>
                                    <div>
                                        <div>
                                            <img src="{{ Storage::url($data_post['photos'][0]) }}" alt="photo principale"
                                        ...
                                        <div class="p-2 d-flex justify-content-start">
                                            @foreach ($data_post['photos'] as $photo)
                                                <div class="gallery-image-details-preview cusor"
                                                    ...
                                                    <img src="{{ Storage::url($photo) }}" alt="photo de détail"
                                                        style="width: 100% !important;">
                                                </div>
                                            @endforeach
                                        </div>
