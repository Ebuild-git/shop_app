        ...
        <div class="row  p-3">
                    ...
                    <div class="col">
                        <div class="form-group">
                            <input type="text" class="form-control shadow-none"
                                placeholder="veuillez renseigner la ville" wire:model="ville" required>
                            @error('ville')
                                <small class="form-text text-danger">{{ $message }}</small>
                            @enderror
                        </div>
            ...
            <div class="col-sm-4">
                ...
                <div class="form-group">
                    ...
                    <span class="bold text-danger">*</span>
                    <input type="file" multiple class="form-control shadow-none" wire:model="photos"
                        @required(!$post)>
                    @error('photos')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
...
VEuillez vous rassurer que votre prublication est complete et exact car apres validation vous n'auriez plus la possibilité de modifer !
</div>
<br>
