     ...
     <form>
         ...
         <div class="row p-3">
             <div class="col-sm-8">
                 ...
                 <div class="row">
                     ...
                     <div class="col-sm-6">
                        ...
                        <input type="email" wire:model="email_send_message" class="form-control">
             ...
             <div class="col-sm-4">
                 ...
                 <hr>
                 <div class="mb-3 mb-3">
                     <input type="checkbox" class="form-check-input" id="" wire:model='valider_photo'
                         @checked($valider_photo)>
                 ...
                 <div class="mb-3 mb-3">
                     <input type="checkbox" class="form-check-input" id="" wire:model='valider_publication'
                         @checked($valider_publication)>
