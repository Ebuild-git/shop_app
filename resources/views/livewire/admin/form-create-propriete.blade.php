        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="mb-3">
                    ...
                    <input type="text" wire:model="nom_en" class="form-control @error('nom_en') is-invalid @enderror" />
                    @error('nom_en')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-sm-4">
                <div class="mb-3">
                    ...
                    <input type="text" dir="rtl" wire:model="nom_ar" class="form-control @error('nom_ar') is-invalid @enderror" />
                    @error('nom_ar')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
