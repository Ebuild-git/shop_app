...
document.addEventListener('DOMContentLoaded', function() {
    ...
    @if (Route::currentRouteName() != 'connexion')
        ...
        <div class="modal fade" id="login" tabindex="1" role="dialog" aria-labelledby="loginmodal"
            aria-hidden="true" style="z-index: 2000; {{ app()->getLocale() == 'ar' ? 'text-align: right; direction: rtl;' : 'text-align: left; direction: ltr;' }}">
    ...
    @php
        $missingProfileInfo = auth()->check() && (
            ...
            auth()->user()->num_appartement === null || auth()->user()->num_appartement === '' ||
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center py-4">
                        ...
                        <ul class="text-left list-unstyled mt-3 px-3">
                            ...
                            @endif
                            @if (auth()->user()->etage === null || auth()->user()->etage === '')
