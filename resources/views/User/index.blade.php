                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-6">
                    <div class="product_grid card b-0">
                        ...
                        <div class="card-footer b-0 p-0 pt-2 bg-white">
                            ...
                            <div class="text-left">
                                <h5 class="fw-bolder fs-md mb-0 lh-1 mb-1"><a href="shop-single-v1.html">Formal Men
                                        Lowers</a></h5>
                                <div class="elis_rty"><span class="ft-bold text-dark fs-sm">$99 - $129</span></div>
                            </div>
                        </div>
                    ...
                    <div class="product_grid card b-0">
                        ...
                        <div class="card-footer b-0 p-0 pt-2 bg-white">
                            <div class="d-flex align-items-start justify-content-between">
                                <div class="text-left">
                                    <div class="form-check form-option form-check-inline mb-1">
                                        <input class="form-check-input" type="radio" name="color3" id="white3"
                                            checked="">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-6">
                    <div class="product_grid card b-0">
                        ...
                        <div class="card-footer b-0 p-0 pt-2 bg-white">
                            ...
                            <div class="text-left">
                                <h5 class="fw-bolder fs-md mb-0 lh-1 mb-1"><a href="shop-single-v1.html">Half Fancy Lady
                                        Dress</a></h5>
                                <div class="elis_rty"><span class="ft-bold text-dark fs-sm">$99 - $129</span></div>
                            </div>
                        </div>
                            ...
                            <div class="d-flex align-items-start justify-content-between">
                                <div class="text-left">
                                    <div class="form-check form-option form-check-inline mb-1">
                                        ...
                                        <label class="form-option-label small rounded-circle" for="white5"><span
                                                class="form-option-color rounded-circle blc8"></span></label>
                                    </div>
                                    <div class="form-check form-option form-check-inline mb-1">
                                        <input class="form-check-input" type="radio" name="color5" id="blue5">
                                        <label class="form-option-label small rounded-circle" for="blue5"><span
                                                class="form-option-color rounded-circle blc5"></span></label>
                                    </div>
                                    <div class="form-check form-option form-check-inline mb-1">
                                        <input class="form-check-input" type="radio" name="color5" id="yellow5">
                                        <label class="form-option-label small rounded-circle" for="yellow5"><span
                                                class="form-option-color rounded-circle blc3"></span></label>
                                    </div>
                                    <div class="form-check form-option form-check-inline mb-1">
                                        <input class="form-check-input" type="radio" name="color5" id="pink5">
                                        <label class="form-option-label small rounded-circle" for="pink5"><span
                                                class="form-option-color rounded-circle blc6"></span></label>
                                    </div>
                                </div>
                                <div class="text-right">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-6">
                    <div class="product_grid card b-0">
                        ...
                        <div class="card-footer b-0 p-0 pt-2 bg-white">
                            <div class="d-flex align-items-start justify-content-between">
                                <div class="text-left">
                                    ...
                                    <div class="form-check form-option form-check-inline mb-1">
                                        ...
                                        <label class="form-option-label small rounded-circle" for="blue6"><span
                                                class="form-option-color rounded-circle blc7"></span></label>
                                    </div>
                                    <div class="form-check form-option form-check-inline mb-1">
                                        <input class="form-check-input" type="radio" name="color6" id="yellow6">
                                        <label class="form-option-label small rounded-circle" for="yellow6"><span
                                                class="form-option-color rounded-circle blc3"></span></label>
                                    </div>
                                    <div class="form-check form-option form-check-inline mb-1">
                                        <input class="form-check-input" type="radio" name="color6" id="pink6">
                                        <label class="form-option-label small rounded-circle" for="pink6"><span
                                                class="form-option-color rounded-circle blc6"></span></label>
                                    </div>
                                </div>
                                <div class="text-right">
                            ...
                            <div class="text-left">
                                <h5 class="fw-bolder fs-md mb-0 lh-1 mb-1"><a href="shop-single-v1.html">Fancy Salwar
                                        Suits</a></h5>
                                <div class="elis_rty"><span class="ft-bold text-dark fs-sm">$99 - $129</span></div>
                            </div>
                        </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-6">
                    <div class="product_grid card b-0">
                        ...
                        <div class="card-footer b-0 p-0 pt-2 bg-white">
                            <div class="d-flex align-items-start justify-content-between">
                                <div class="text-left">
                                    <div class="form-check form-option form-check-inline mb-1">
                                        ...
                                        <label class="form-option-label small rounded-circle" for="white7"><span
                                                class="form-option-color rounded-circle blc2"></span></label>
                                    </div>
                                    <div class="form-check form-option form-check-inline mb-1">
                                        <input class="form-check-input" type="radio" name="color7" id="blue7">
                                        <label class="form-option-label small rounded-circle" for="blue7"><span
                                                class="form-option-color rounded-circle blc8"></span></label>
                                    </div>
                                    <div class="form-check form-option form-check-inline mb-1">
                                        <input class="form-check-input" type="radio" name="color7" id="yellow7">
                                        <label class="form-option-label small rounded-circle" for="yellow7"><span
                                                class="form-option-color rounded-circle blc3"></span></label>
                                    </div>
                                    <div class="form-check form-option form-check-inline mb-1">
                                        <input class="form-check-input" type="radio" name="color7" id="pink7">
                                        <label class="form-option-label small rounded-circle" for="pink7"><span
                                                class="form-option-color rounded-circle blc6"></span></label>
                                    </div>
                                </div>
                                <div class="text-right">
                            ...
                            <div class="text-left">
                                <h5 class="fw-bolder fs-md mb-0 lh-1 mb-1"><a href="shop-single-v1.html">Printed Straight
                                        Kurta</a></h5>
                                <div class="elis_rty"><span class="ft-bold text-dark fs-sm">$99 - $129</span></div>
                            </div>
                        </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-6">
                    <div class="product_grid card b-0">
                        ...
                        <div class="card-footer b-0 p-0 pt-2 bg-white">
                            <div class="d-flex align-items-start justify-content-between">
                                <div class="text-left">
                                    <div class="form-check form-option form-check-inline mb-1">
                                        ...
                                        <label class="form-option-label small rounded-circle" for="white88"><span
                                                class="form-option-color rounded-circle blc7"></span></label>
                                    </div>
                                    <div class="form-check form-option form-check-inline mb-1">
                                        <input class="form-check-input" type="radio" name="color88" id="blue88">
                                        <label class="form-option-label small rounded-circle" for="blue88"><span
                                                class="form-option-color rounded-circle blc2"></span></label>
                                    </div>
                                    <div class="form-check form-option form-check-inline mb-1">
                                        <input class="form-check-input" type="radio" name="color88" id="yellow88">
                                        <label class="form-option-label small rounded-circle" for="yellow88"><span
                                                class="form-option-color rounded-circle blc5"></span></label>
                                    </div>
                                    <div class="form-check form-option form-check-inline mb-1">
                                        <input class="form-check-input" type="radio" name="color88" id="pink88">
                                        <label class="form-option-label small rounded-circle" for="pink88"><span
                                                class="form-option-color rounded-circle blc3"></span></label>
                                    </div>
                                </div>
                                <div class="text-right">
                            ...
                            <div class="text-left">
                                <h5 class="fw-bolder fs-md mb-0 lh-1 mb-1"><a href="shop-single-v1.html">Collot Full
                                        Dress</a></h5>
                                <div class="elis_rty"><span class="ft-bold text-dark fs-sm">$99 - $129</span></div>
                            </div>
                        </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                    <div class="_blog_wrap">
                        <div class="_blog_thumb mb-2">
                            <a href="blog-detail.html" class="d-block"><img src="https://via.placeholder.com/900x700"
