...
Route::group(['middleware' => ['auth', 'role']], function () {
    ...
    Route::get('/admin/messages', [UserController::class, 'liste_messages'])->name('liste_messages');
    ...
    Route::get('/admin/alertes', [AdminController::class, 'alerts'])
    ->name('admin.orders.alerts');
    Route::post('/admin/client/{id}/validate-photo', [UserController::class, 'validatePhoto'])->name('admin.validate.photo');
    Route::delete('/admin/client/{id}/reject-photo', [UserController::class, 'rejectPhoto'])->name('admin.reject.photo');
    ...
    Route::post('/admin/commande/{id}/cancel-pickup', [OrdersController::class, 'cancelPickup']);
    ...
    Route::delete('/admin/order-items/{item}/force', [OrdersController::class, 'forceDeleteItem'])->name('order-items.force-delete');
